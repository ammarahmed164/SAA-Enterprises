    ...
    <div className="container py-12 md:py-16">
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            This privacy policy sets out how SAA Enterprises uses and protects any
            information that you give SAA Enterprises when you use this website. SAA
            Enterprises is committed to ensuring that your privacy is protected. Should
